...
class OllamaEmbeddings:
    ...
    def embed(self, text: str) -> np.ndarray:
        ...
        """
        try:
            response = requests.post(f"{self.base_url}/api/embed", json={"model": self.model, "input": text}, timeout=300)
...
def embed_chunks(chunks: List, model: str = "nomic-embed-text", batch_size: int = 10) -> tuple:
    """
