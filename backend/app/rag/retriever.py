...
class RAGRetriever:
    ...
    def __init__(self, vector_store: FAISSVectorStore, embedding_model: str = "nomic-embed-text"):
        """
    ...
    def retrieve_with_context(self, query: str, k: int = 5) -> List[Dict[str, Any]]:
        """
        ...
        for result in results:
            ...
            result["context"] = {"chunk_id": chunk_id, "source": source}
