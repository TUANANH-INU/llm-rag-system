...
class FAISSVectorStore:
    ...
    def add_vectors(self, embeddings: np.ndarray, metadata: List[Dict[str, Any]], texts: List[str]) -> None:
        """
    ...
    def save(self, path: str) -> None:
        ...
        # Save config
        config = {"embedding_dim": self.embedding_dim, "num_vectors": len(self.chunk_texts)}
