...
class RAGSystem:
    ...
    def _process_documents(self) -> None:
        ...
        # Create chunks
        chunks = create_chunks(self.documents, chunk_size=self.chunk_size, overlap=self.chunk_overlap)
        self.chunks.extend(chunks)

        # Embed chunks
        embeddings, embedding_dim = embed_chunks(self.chunks, model=self.embedding_model)
